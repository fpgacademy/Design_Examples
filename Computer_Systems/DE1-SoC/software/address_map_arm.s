        .equ  DDR_BASE,              0x00000000  /* Memory */
        ...
        .equ  LED_BASE,              0xFF200000   /* Cyclone V FPGA devices */
        ...
        .equ  RGB_RESAMPLER_BASE,    0xFF203010
        ...
        .equ   HPS_GPIO1_BASE,       0xFF709000   /* Cyclone V HPS devices */
        ...
        .equ   PERIPH_BASE,          0xFFFEC000   /* ARM peripherals base */
        .equ   MPCORE_PRIV_TIMER,    0xFFFEC600 

        .equ   MPCORE_GIC_CPUIF,     0xFFFEC100   /* GIC base */
        .equ   ICCICR,               0x00         /* CPU interface control */
        .equ   ICCPMR,               0x04         /* interrupt priority mask */
        .equ   ICCIAR,               0x0C         /* interrupt acknowledge */
        .equ   ICCEOIR,              0x10         /* end of interrupt */
        .equ   MPCORE_GIC_DIST,      0xFFFED000   /* GIC distributot */
        .equ   ICDDCR,               0x00         /* distributor control */
        .equ   ICDISER,              0x100        /* set-enable */
        .equ   ICDICER,              0x180        /* clear-enable */
        .equ   ICDIPTR,              0x800        /* processor targets */
        .equ   ICDICFR,              0xC00        /* configuration */
