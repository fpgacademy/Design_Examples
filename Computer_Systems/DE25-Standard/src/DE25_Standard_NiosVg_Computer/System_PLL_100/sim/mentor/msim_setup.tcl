...
alias com {
  ...
  set common_design_files [dict values [System_PLL_100::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [System_PLL_100::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
